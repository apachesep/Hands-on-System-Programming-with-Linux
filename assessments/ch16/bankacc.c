 ...
 ****************************************************************
 * Brief Description:
 * Write a simple 'banking app' as a multithreaded process (as described
 * earlier in this chapter), just implementing the deposit and withdraw
 * functions. Test it with and without using the mutex lock to protect
 * critical sections.
