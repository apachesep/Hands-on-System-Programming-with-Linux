 ...
 * atomic_A, atomic_B: As explained in the section "Signal-Safe
 * Atomic Integers", implement a small application with two processes
 * 'A' and 'B'. Have 'A' complete some work and signal 'B' that it has
 * done so. Do this in an atomic fashion (no data races). 
 *
