...
starting this app. Watch the screen carefully; the moment
it starts, press ^C (Ctrl+c simultaneously)!
 ...
 *
 * WARNING! Using the [f]printf in a signal handler is unsafe!
 * We do so for the purposes of this demo app only; do not
 * use in production.
 */
